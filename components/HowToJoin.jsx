...
const STEPS = [
  ...
  },
  {
    ...
    d: "Vous recevez votre accès au dashboard Club des Informateurs et à l'espace investisseurs privé.",
  },
];
      ...
      <div className="mx-auto max-w-[1180px] px-6">
        <Reveal className="max-w-2xl">
          ...
          <h2 className="mt-5 font-display font-light text-[32px] md:text-[44px] leading-[1.08] tracking-tightest text-bone">
            Accéder à Club des Informateurs en trois étapes
          </h2>
        </Reveal>
        ...
        <Reveal delay={0.1}>
          <motion.div className="relative mt-12 rounded-3xl border gold-line overflow-hidden">
            <div
              ...
              style={{
                background:
                  "radial-gradient(80% 120% at 80% -20%, rgba(46,230,168,0.18), transparent 55%), radial-gradient(60% 100% at 0% 120%, rgba(46,230,168,0.08), transparent 60%)",
              }}
            />
