  ...
  const FuturesCTAs = () => (
    <div className="mb-5 flex flex-col gap-2">
      ...
      <button
        ...
        className="w-full flex items-center gap-2 justify-between rounded-xl border border-violet-500/30 bg-gradient-to-r from-violet-900/30 to-ink-900 px-4 py-2.5 hover:border-violet-400/50 transition-colors"
      >
        <div className="flex items-center gap-2 min-w-0">
          <svg viewBox="0 0 24 24" className="h-4 w-4 shrink-0 text-violet-400" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
            <rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/>
          </svg>
          <span className="text-[13px] text-bone font-medium">Rejoindre le groupe privé — Copy Forex MoonX</span>
        </div>
        <span className="inline-flex items-center gap-1.5 rounded-full border border-violet-500/40 bg-violet-500/10 px-3 py-1.5 text-[11px] font-semibold text-violet-300 whitespace-nowrap shrink-0">
          Accéder <IconArrow className="h-3 w-3" />
        </span>
      </button>
    </div>
  );
