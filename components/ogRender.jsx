    ...
    (
      <div
        style={{
          ...
          backgroundImage:
            "radial-gradient(circle at 84% -6%, rgba(201,162,75,0.24), transparent 55%), radial-gradient(circle at -4% 112%, rgba(201,162,75,0.10), transparent 55%)",
          color: "#ECE9E1",
          fontFamily: "serif",
        }}
      >
          ...
          <div style={{ display: "flex", gap: "14px" }}>
            {[
              ...
              >
                ...
                <div style={{ fontSize: "30px", fontWeight: 700, color: "#E8CE8E" }}>{v}</div>
              </div>
            ))}
          </div>
          <div
